...
# label = np.hstack((zero_label, one_label, two_label, three_label, four_label, five_label, six_label, seven_label, eight_label, nine_label,
#                    A_label, B_label, C_label, D_label, E_label, F_label, G_label, H_label, J_label, K_label, L_label, M_label, N_label, P_label,
#                    Q_label, R_label, S_label, T_label, U_label, V_label, W_label, X_label, Y_label, Z_label))
# 
# images = np.vstack((zero_number, one_number, two_number, three_number, four_number, five_number, six_number, seven_number, eight_number, nine_number,
#                     A_letter, B_letter, C_letter, D_letter, E_letter, F_letter, G_letter, H_letter, J_letter, K_letter, L_letter, M_letter, N_letter,
#                     P_letter, Q_letter, R_letter, S_letter, T_letter, U_letter, V_letter, W_letter, X_letter, Y_letter, Z_letter))
# print images.shape
# print label.shape
